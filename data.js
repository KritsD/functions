        ...
        case "A minute":
            switch (dataList2) {
                case "Headache":
					...
					resultsfeelingHeader.innerHTML = "symptom: <br> HEADACHE";
					resultstimeHeader.innerHTML = "time:<br> A MINUTE";
					resultsremedyHeader.innerHTML = "remedy:<br> USE PROPER LIGHTING";
					break;
				case "Sore eyes":
					...
					resultsfeelingHeader.innerHTML = "symptom:<br> SORE EYES";
					resultstimeHeader.innerHTML = "time:<br> A MINUTE";
					resultsremedyHeader.innerHTML = "remedy:<br>PALM THE EYES";
					break;  
				case "Blurred vision":
					...
					resultsfeelingHeader.innerHTML = "symptom: <br> BLURED VISION";
					resultstimeHeader.innerHTML = "time:<br> A MINUTE";
					resultsremedyHeader.innerHTML = "remedy:<br> FOLLOW 20-20-20 RULE";
                    break;
				case "Shoulder/neck pain":
					...
					resultsfeelingHeader.innerHTML = "symptom: <br> SHOULDER/NECK PAIN";
					resultstimeHeader.innerHTML = "time: <br>A MINUTE";
					resultsremedyHeader.innerHTML = "remedy:<br> NECK & SHOULDER ROLLS";
					break;  
				case "Eye Fatigue":
					...
					resultsfeelingHeader.innerHTML = "symptom:<br>EYE FATIGUE";
					resultstimeHeader.innerHTML = "time: <br>A MINUTE";
					resultsremedyHeader.innerHTML = "remedy:<br> FLEX THE EYES";
					break; 
            }
			break;
		...
		case "Some time":
        	switch (dataList2){
                case "Headache":
					...
					resultsfeelingHeader.innerHTML = "symptom: <br> HEADACHE";
					resultstimeHeader.innerHTML = "time: <br>SOME TIME";
					resultsremedyHeader.innerHTML = "remedy: <br>CLOSE EYES & BREATHE";
                    break;
                case "Sore eyes":
					...
					resultsfeelingHeader.innerHTML = "symptom:<br> SORE EYES";
					resultstimeHeader.innerHTML = "time:<br> SOME TIME";
					resultsremedyHeader.innerHTML = "remedy: <br>A WARM COMPRESS";
                    break;  
				case "Blurred vision":
					...
					resultsfeelingHeader.innerHTML = "symptom: <br> BLURED VISION";
					resultstimeHeader.innerHTML = "time:<br> SOME TIME";
					resultsremedyHeader.innerHTML = "remedy:<br> COOLED CHAMOMILE BAGS";
					break;
				case "Shoulder/neck pain":
					...
					resultsfeelingHeader.innerHTML = "symptom: <br> SHOULDER/NECK PAIN";
					resultstimeHeader.innerHTML = "time: <br>SOME TIME";
					resultsremedyHeader.innerHTML = "remedy:<br>ADJUST YOUR SCREEN";
					break;  
				case "Eye Fatigue":
					result = "<span class='p2'>Take a screen break, rest your eyes for several minutes</span>";
					resultsfeelingHeader.innerHTML = "symptom:<br>EYE FATIGUE";
					resultstimeHeader.innerHTML = "time:<br> SOME TIME";
					resultsremedyHeader.innerHTML = "remedy:<br>REST";
					break;   
            	}
				break;
    	}
