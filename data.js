...
function outputSolution(){
    ...
    switch (dataList){
        case "A minute":
            switch (dataList2) {
                case "Headache":
					result ="<span class='image'><img class='imagealign' src='lamp.gif'></span>";
					...
					break;
				case "Sore eyes":
					result ="<span class='image'><img class='imagealign' src='palms.gif'></span>";
					...
					break;  
				case "Blurred vision":
					result ="<span class='image'><img class='imagealign' src='202020.gif'></span>";
				...
				case "Shoulder/neck pain":
					result ="<span class='image'><img class='imagealign' src='headroll.gif'></span>";
					...
					break;  
				case "Eye Fatigue":
					result ="<span class='image'><img class='imagealign' src='lookup.gif'></span>";
		...
		case "Some time":
        	switch (dataList2){
                case "Headache":
					result ="<span class='image'><img class='imagealign' src='rest.gif'></span>";
                    ...
                    break;
                case "Sore eyes":
					result ="<span class='image'><img class='imagealign' src='washcloth.gif'></span>";
                    ...
                    break;  
				case "Blurred vision":
					result ="<span class='image'><img class='imagealign' src='tea.gif'></span>";
					...
					break;
				case "Shoulder/neck pain":
					result ="<span class='image'><img class='imagealign' src='desk.gif'></span>";
					...
					break;  
				case "Eye Fatigue":
					result ="<span class='image'><img class='imagealign' src='sleep.gif'></span>";
