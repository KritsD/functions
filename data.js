        ...
        case "A minute":
            switch (dataList2) {
                case "Headache":
                    ...
                    result = "<span class='p1'>blink slowly</span>";
					result += "<span class='p2'>Blinking several times can help spread the tears across your eyes, reducing burning or sore feelings.</span>";
					result +="<span class='p2'>Looking straight ahead, close your eyes for half a second, then reopen them. Repeat this 20 times in a row to refresh your eyes and reduce dryness.</span>";
				...
				case "Sore eyes":
					result = "<span class='p1'>Palming the eyes</span>";
